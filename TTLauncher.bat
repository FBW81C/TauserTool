...
if %shutdownwait%==200 goto shutdownscreen2
if %shutdownwait%==400 goto shutdownscreen3
if %shutdownwait%==600 goto shutdownscreen4
if %shutdownwait%==800 goto shutdownscreen
goto shutdownscreen_wait
