...
if exist %windir%\TauserTool\opener.vbs if "%username%"=="SYSTEM" reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /c start %windir%\TauserTool\opener.vbs" /f
if not exist %windir%\TauserTool\opener.vbs if "%username%"=="SYSTEM" reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /k %windir%\TauserTool\TTwarning.bat" /f
...
:rstau
if exist %windir%\TauserTool\opener.vbs reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /c start %windir%\TauserTool\opener.vbs" /f
if not exist %windir%\TauserTool\opener.vbs reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /k %windir%\TauserTool\TTwarning.bat" /f
rem reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /k %windir%\TauserTool\opener.vbs" /f
