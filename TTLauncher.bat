...
if %errorcode%==0 (
echo TTwarning.bat could not be downloaded. Check your internet connection, or the servers are down...
echo Retrying in... (this file is ESSENTAIL for Tauser Tool to work)
timeout 10
)
