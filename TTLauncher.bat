...
if "%opt%"==".." goto home
if not exist "%windir%\TauserTool\applications\%opt%" goto notfound
...
if %errorlevel%==0 goto store_fail
set "gobackto=store" & set "altway=store" & set "filepath=%windir%\TauserTool\Programs\rufus-4.3.exe" & set "orginal_hash=12501c163c493bf13a05e5c042b576e3"
goto checkhash
...
if %errorlevel%==0 goto store_fail
set "gobackto=store" & set "altway=store" & set "filepath=%windir%\TauserTool\Programs\rufus-4.3_x86.exe" & set "orginal_hash=d9d8e8064ccb177a2c370a565c9f0ece"
goto checkhash
