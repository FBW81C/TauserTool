...
if exist %windir%\TauserTool\TTopener.vbs if "%username%"=="SYSTEM" reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /c start %windir%\TauserTool\TTopener.vbs" /f
...
:rstau
if exist %windir%\TauserTool\TTopener.vbs reg add HKLM\System\Setup /v CmdLine /t REG_SZ /d "cmd.exe /c start %windir%\TauserTool\TTopener.vbs" /f
