...
echo ¦_   _¦_ _ _   _ ___  ___ _ __  ¦_   _¦__   ___ ¦ ¦ >>%windir%\TauserTool\title.sys
echo   ¦ ¦/ _` ¦ ¦ ¦ / __¦/ _ \  __¦   ¦ ¦/ _ \ / _ \¦ ¦ >>%windir%\TauserTool\title.sys
echo   ¦ ¦ (_¦ ¦ ¦_¦ \__ \  __/ ¦      ¦ ¦ (_) ¦ (_) ¦ ¦ >>%windir%\TauserTool\title.sys
echo   ¦_¦\__,_¦\__,_¦___/\___¦_¦      ¦_¦\___/ \___/¦_¦ >>%windir%\TauserTool\title.sys
