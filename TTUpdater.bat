...
fc %windir%\TauserTool\temp\empty.sys %windir%\TauserTool\version.sys
...
type nul>%windir%\TauserTool\temp\empty.sys
fc %windir%\TauserTool\temp\empty.sys %windir%\TauserTool\TTLauncher.update
if %errorlevel%==0 goto fail
...
type nul>%windir%\TauserTool\temp\empty.sys
fc %windir%\TauserTool\temp\empty.sys %windir%\TauserTool\WGET\orginal_TTLauncherhash.sys
if %errorlevel%==0 goto fail
